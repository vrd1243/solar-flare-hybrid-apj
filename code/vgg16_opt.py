...
import importlib
import data_opt
from data_opt import get_loader, generateTrainValidData
import json 
...
def main():
    ...
    sunspotTrainSet, sunspotValidSet, sunspotTestSet = generateTrainValidData(df, root_dir='/srv/data/hdf5/', splitType=splitType)
